...
echo Food,150,$(date +%y%m%d),Payday,-150,Transfer | tee -a Food.txt Total.txt >/dev/null
echo Payday,-150,$(date +%y%m%d),Food,150,Transfer | tee -a Payday.txt Total.txt >/dev/null
echo Live,88,$(date +%y%m%d),Payday,-88,Transfer | tee -a Live.txt Total.txt >/dev/null
echo Payday,-88,$(date +%y%m%d),Live,88,Transfer | tee -a Payday.txt Total.txt >/dev/null
...
echo Extras,85,$(date +%y%m%d),Payday,-85,Transfer | tee -a Extras.txt Total.txt >/dev/null
echo Payday,-85,$(date +%y%m%d),Extras,85,Transfer | tee -a Payday.txt Total.txt >/dev/null
...
echo HOA,125,$(date +%y%m%d),Payday,-125,Transfer | tee -a HOA.txt Total.txt >/dev/null
echo Payday,-125,$(date +%y%m%d),HOA,125,Transfer | tee -a Payday.txt Total.txt >/dev/null
