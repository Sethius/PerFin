...
./Input.sh Debts,-50,$(date +%y%m%d),Payday,50,Transfer
./Input.sh Emergency,265,$(date +%y%m%d),Payday,-265,Transfer
./Input.sh Extras,190,$(date +%y%m%d),Payday,-190,Transfer
...
./Input.sh Live,210,$(date +%y%m%d),Payday,-210,Transfer
