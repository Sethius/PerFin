...
echo Debts,84,$(date +%y%m%d),Payday,-84,Transfer | tee -a Debts.txt Total.txt >/dev/null
echo Payday,-84,$(date +%y%m%d),Debts,84,Transfer | tee -a Payday.txt Total.txt >/dev/null
