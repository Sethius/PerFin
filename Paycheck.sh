...
echo Live,124,$(date +%y%m%d),Payday,-124,Transfer | tee -a Live.txt Total.txt >/dev/null
echo Payday,-124,$(date +%y%m%d),Live,124,Transfer | tee -a Payday.txt Total.txt >/dev/null
