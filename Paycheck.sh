...
echo Live,95,$(date +%y%m%d),Payday,-95,Transfer | tee -a Live.txt Total.txt >/dev/null
echo Payday,-95,$(date +%y%m%d),Live,95,Transfer | tee -a Payday.txt Total.txt >/dev/null
echo Emergency,350,$(date +%y%m%d),Payday,-350,Transfer | tee -a Emergency.txt Total.txt >/dev/null
echo Payday,-350,$(date +%y%m%d),Emergency,350,Transfer | tee -a Payday.txt Total.txt >/dev/null
echo House,350,$(date +%y%m%d),Payday,-350,Transfer | tee -a House.txt Total.txt >/dev/null
echo Payday,-350,$(date +%y%m%d),House,350,Transfer | tee -a Payday.txt Total.txt >/dev/null
